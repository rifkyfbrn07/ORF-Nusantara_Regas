              ...
              <tbody key={group.category} className="border-t-2 border-[#DCE5EF]">
                ...
                {group.items.map((p) => (
                  <tr key={p.id} className="align-top hover:bg-[#F8FBFE]">
                    ...
                    <td className="px-3 py-3 text-[11px] font-semibold text-text-secondary">{p.pic?.name || 'Belum ditetapkan'}</td>
